  ...
  return (
    <div className="flex flex-row">
      <div className="flex flex-col items-center">
        ...
        <span className="text-[16px] font-[share] font-semibold">Days</span>
      </div>
      ...
      <div className="flex flex-col items-center">
        ...
        <span className="text-[16px] font-[share] font-semibold">Hours</span>
      </div>
      ...
      <div className="flex flex-col items-center">
        ...
        <span className="text-[16px] font-[share] font-semibold">Minutes</span>
      </div>
      ...
      <div className="flex flex-col items-center">
        ...
        <span className="text-[16px] font-[share] font-semibold">Seconds</span>
      </div>
    </div>
  );
}
